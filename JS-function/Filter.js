...
Lack-knowledge: 
+ call(): hàm này nhận vào tham số đầu tiên là thisArg, đây sẽ là giá trị biến this trong hàm này hàm apply() cũng tương tự call(), khác cái là apply() nhận vào tham số thứ 2 là một mảng, còn call() 2nd argument dưới dạng liệt kê.
